...
export class UsersService implements OnModuleInit {
  ...
  async onModuleInit() {
    ...
    if (vehicleCount === 0) {
      ...
      this.logger.log('Дефолтные машины созданы');
    }
    ...
    if (driverCount === 0) {
      await this.driversRepository.save([
        { fullName: 'Иванов Иван Иванович', licenseNumber: '7701 123456', licenseCategory: 'B, C' },
        { fullName: 'Петров Петр Петрович', licenseNumber: '7702 654321', licenseCategory: 'C, E' },
      ] as Driver[]);
      this.logger.log('Дефолтных водители созданы');
    }
  }
